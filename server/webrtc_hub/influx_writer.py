        ...
        for table in tables:
            for record in table.records:
                ...
                if field == "predicted_cpu" and value is not None:
                    ...
                    metric_name = {"cpu": "CPU", "memory": "Memory", "disk_io": "DiskIO", "diskio": "DiskIO", "networksent": "NetworkSent", "networkrecv": "NetworkRecv", "process": "Process", "dongle": "Dongle", "hand_scanner": "HandScanner", "handscanner": "HandScanner", "passport_reader": "PassportReader", "passportreader": "PassportReader", "2d_scanner": "2DScanner", "2dscanner": "2DScanner", "phone_charger": "PhoneCharger", "phonecharger": "PhoneCharger", "keyboard": "Keyboard", "msr": "MSR", "pos_idle": "POS_Idle"}.get(metric_key, metric_key)
